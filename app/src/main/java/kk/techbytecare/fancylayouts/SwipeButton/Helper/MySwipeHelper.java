package kk.techbytecare.fancylayouts.SwipeButton.Helper;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton {
        ...
        String text;
        int image_res_id, textSize, color, pos;
        ...
        public MyButton(Context context, String text, int image_res_id, int textSize, int color, MyButtonClickListener listener) {
            this.text = text;
        ...
        public void onDraw(Canvas c,RectF rectF, int pos)   {
            ...
            if (image_res_id == 0)  {
                ...
                c.drawText(text,rectF.left+y,rectF.top+y,p);
            }
            else    {

                Drawable d = ContextCompat.getDrawable(context,image_res_id);
    ...
    public float getSwipeThreshold(RecyclerView.ViewHolder v) {
    ...
    public abstract void initiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer);
